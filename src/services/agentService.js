...
function systemInstruction(services, lang) {
    ...
    return [
        ...
        "4. Answer questions about the salon, services, prices, location, aftercare or policies using the SALON FACTS below or the tools (list_services, get_salon_info).",
        "   Present service lists or options clearly in a numbered list. Never invent unlisted prices or services.",
